            ...
            <View style={{padding: moderateScale(15)}}>
              ...
              <View style={{...styles.info}}>
                <View
                  ...
                  <Text
                    ...
                    {LanguageSelector.t('support.model')}
                  </Text>
                  <Text
                    style={{
                ...
                <View
                  ...
                  <Text
                    ...
                    {LanguageSelector.t('support.vehicleId')}
                  </Text>
                  <Text
                    style={{
              ...
              <View style={styles.textInput}>
                ...
                <Textarea
                  ...
                  rowSpan={7}
                  bordered
                  placeholder={LanguageSelector.t(
                    'support.commentsPlaceholder',
                  )}
