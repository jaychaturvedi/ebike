...
import { ReactComponent as CustomerCareLogo } from "../../assets/svg/CustomerCare.svg"
    ...
    return (
      <div className="connectm-LeftPanel">
        <div className={"left-panel"}>
          ...
          <div className={`tab-icons ${this.state.b2bClicked ? "option-clicked" : ""}`} onClick={()=>this.b2bClicked("b2b")}>
            <CustomerCareLogo width="32" height="32" />
            <Typography.Text >CC</Typography.Text>
          </div>
        </div>
      </div>
    )
