...
class CellBatteryGraph extends PureComponent<
  CellBatteryGraphProps,
  CellBatteryGraphStates
> {
  ...
  static getDerivedStateFromProps(
    props: CellBatteryGraphProps,
    state: CellBatteryGraphStates
  ) {
    let data = state.data;
      ...
      if (label === "empty") {
        ...
        return (
          <div className='custom-tooltip' style={style}>
            <p className='label'>{`${
              payload[0]?.value ? payload[0]?.value + " V" : ""
            }`}</p>
    ...
    return (
      <div className='connectm-AlertDetailGraph voltage-deviation'>
        ...
        <div
          ...
          className='graph-and-difference-container'
        >
          <div className='voltage-deviation-top'>
            <span className='normal-operating-voltage-text'>
              Normal
              <br />
              Operating
              <br />
                ...
                {!this.props.alertCleared ? (
                  <Bar dataKey={this.props.barDataKey} radius={[10, 10, 0, 0]}>
                    {this.state.data1.map((entry: any, index: number) => (
                      <Cell
                        fill={
                          entry[this.props.barDataKey] <= this.props.minL1 ||
                          entry[this.props.barDataKey] > this.props.maxL2
                            ? "red"
                            : "#73A93C"
                        }
                        key={index}
