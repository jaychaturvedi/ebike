...
> {
  ...
  static getDerivedStateFromProps(
    props: DualAxisGraphProps,
    state: DualAxisGraphStates
  ) {
    let data = state.data;
  ...
  CustomTooltip = (obj: any) => {
    ...
    let localAlertTime = formatDateTime(
      line[0]?.payload?.xAxisValue,
      formatType
    );
    if (line?.length === 0) return null;
    if (
      this.props.xAxisLabel === "No of Cycles" ||
      localAlertTime === "Invalid date"
    ) {
      localAlertTime = line[0]?.payload?.xAxisValue;
    }
    return (
            ...
            >
              ...
              {!this.props.alertCleared ? (
                <Line
                  ...
                  activeDot={{
                    onMouseOver: (e: any) =>
                      this.setState({ lineTooltipType: this.state.line1Key! }),
                    onMouseLeave: (e: any) =>
              ...
              {!this.props.alertCleared ? (
                <Line
                  ...
                  activeDot={{
                    onMouseOver: (e: any) =>
                      this.setState({ lineTooltipType: this.state.line2Key! }),
                    onMouseLeave: (e: any) =>
                      this.setState({ lineTooltipType: "" }),
                  }}
                />
