...
class AlertDetailGraph extends PureComponent<
  AlertDetailGraphProps,
  AlertDetailGraphStates
> {
  ...
  static getDerivedStateFromProps(
    props: AlertDetailGraphProps,
    state: AlertDetailGraphStates
  ) {
    let data = state.data;
    ...
    if (this.props.xAxisLabel === "No of Cycles") {
      return (
        <div className='custom-tooltip' style={style}>
          ...
          <p className='label'>
            {this.props.xAxisLabel} : {`${line[0]?.payload?.xAxisValue}`}
          </p>
        </div>
      );
    }
